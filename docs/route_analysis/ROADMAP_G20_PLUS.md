...
这是 G20 的路线建议。G21 后续已独立启动并完成 branch R3/R4 validation；G22、G23、G24、G25 仍需独立审计、计划、执行、验收和合并。
...
| G21 | Asset Contract Foundation | 建立资产/物品/奖励/标签/策略的最小 public contract，与现有 ledger 和 future long-term shell 对齐 | R3 complete at `29a68e7b093ae653be212e32eb97042c0a7c0a4c`; R4 Godot headless project-load/parser smoke PASS; R4B docs-only closeout; not merged main |
...
- G21 尚未合并 main，后续 main merge 仍需独立授权。
