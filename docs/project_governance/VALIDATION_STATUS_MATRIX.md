...
| G20-final | post-merge docs calibration; final docs commit hash pending until commit | not run | not run / not claimed | not claimed | yes | this execution; main first merge `ae689b7464fd6ea81a763110cd89813abcfb6665` | Godot parser smoke; manual playtest; full gameplay runtime | G20 final merged main and calibrates docs only; G21 not started. |
