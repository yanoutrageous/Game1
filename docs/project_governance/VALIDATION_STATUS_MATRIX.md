...
- G20 当前是 docs-only governance，已 fast-forward 合并 main；不运行 Godot，不声明 parser smoke，不声明 gameplay runtime PASS，不声明 manual playtest PASS。
...
| G20-R3a | docs-only static inventory | not run | not run / not claimed | not claimed | yes | `docs/NEXT_HANDOFF.md`; `docs/ENGINEERING_STATUS.md`; `git show caaf3c5` | Godot parser smoke; manual playtest; full gameplay runtime | Design source text copy import only; no Godot project/scenes/resources validation claim. |
| G20-R3b | docs-only static inventory | not run | not run / not claimed | not claimed | yes | `docs/NEXT_HANDOFF.md`; `docs/ENGINEERING_STATUS.md`; `git show 81513bd` | Godot parser smoke; manual playtest; full gameplay runtime | Governance maps and indexes only. |
| G20-R3c | docs-only static inventory | not run | not run / not claimed | not claimed | yes | `docs/DOCS_INDEX.md`; `docs/route_analysis/ROUTE_ANALYSIS_G10_TO_G19.md`; `git show 10a2dd3` | Godot parser smoke; manual playtest; full gameplay runtime | Stage summaries and route analysis only; G21 not started. |
| G20-R3d1 | docs-only git/diff validation in this execution | not run | not run / not claimed | not claimed | yes | `docs/project_governance/BRANCH_INVENTORY.md`; `docs/project_governance/COMMIT_MILESTONE_MAP.md`; this file | Godot parser smoke; manual playtest; full gameplay runtime | R3d1 adds branch, commit, and validation matrices only. |
| G20-R3d2 | docs-only executed / completed; commit `ef30741902f0cf9e9984e20de3ceef696b30523a` | not run | not run / not claimed | not claimed | yes | R3d2 governance docs; `git show ef307419` | Godot parser smoke; manual playtest; full gameplay runtime | R3d2 completed docs-only; Godot not run; parser smoke PASS, manual playtest PASS, and full gameplay runtime PASS are not claimed. |
| G20-R4A | read-only acceptance PASS; blocker fix `82e2b1c6bec8311a144b42dd69950e4bfd500d9c` | not run | not run / not claimed | not claimed | yes | `docs/validation/G20_PROJECT_KNOWLEDGE_GOVERNANCE_VALIDATION.md`; `git show 82e2b1c` | Godot parser smoke; manual playtest; full gameplay runtime | R4A was read-only/docs validation; no Godot run. |
| G20-R4B | docs-only closeout; commit `ae689b7464fd6ea81a763110cd89813abcfb6665` | not run | not run / not claimed | not claimed | yes | `docs/validation/G20_PROJECT_KNOWLEDGE_GOVERNANCE_VALIDATION.md`; `docs/handoff/HANDOFF_G20_PROJECT_KNOWLEDGE_GOVERNANCE.md`; `git show ae689b7` | Godot parser smoke; manual playtest; full gameplay runtime | R4B closeout is the first main merge baseline; no Godot run. |
| G20-final | post-merge docs calibration complete | not run | not run / not claimed | not claimed | yes | main first merge `ae689b7464fd6ea81a763110cd89813abcfb6665` | Godot parser smoke; manual playtest; full gameplay runtime | G20 final merged main and calibrates docs only. |
| G21-R3/R4B/final | contract foundation complete and merged to main | Godot headless project-load/parser smoke PASS | not claimed | not claimed | yes | `docs/validation/G21_ASSET_ITEM_FLOW_CONTRACT_VALIDATION.md`; `docs/handoff/HANDOFF_G21_ASSET_ITEM_FLOW_CONTRACT.md`; main first G21 commit `fdadd78ccdf1d61378ac93a74cfe26449e47c411` | manual playtest PASS; full gameplay runtime; real asset system | G21 is schema / constants / default / normalize / validate / projection schema only; not a real asset system. |
| G21-R5 | docs-only design alignment calibration | not run | not run / not claimed | not claimed | yes | `docs/route_analysis/ROADMAP_G20_PLUS.md`; `docs/route_analysis/SYSTEM_BOUNDARY_MAP.md`; `docs/project_governance/DECISION_LOG.md` | Godot parser smoke; manual playtest; full gameplay runtime; G22 execution | Full Base Docs consistency audit had no P0; P1/P2 route and foundation wording gaps recorded; G22 not started. |
