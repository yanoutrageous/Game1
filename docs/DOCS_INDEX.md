...
- `docs/project_governance/BRANCH_INVENTORY.md`
...
- `docs/handoff/HANDOFF_G20_PROJECT_KNOWLEDGE_GOVERNANCE.md` records the G20 project knowledge governance docs-only closeout, main merge status, safety boundaries, and post-merge docs calibration boundary.
