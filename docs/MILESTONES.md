...
| G21 | Asset & Item Flow Contract Foundation | R3 complete on `godot/g21-asset-item-flow-contract` at `29a68e7b093ae653be212e32eb97042c0a7c0a4c`; baseline main HEAD `4bb4594fc23b846da9c15003a86c71cf08003830`; adds contract-only schema/default/normalize/validate/projection helpers; G21-R4 Godot headless project-load/parser smoke PASS; R4B docs-only closeout branch-only; no real asset system, no gameplay runtime PASS, no manual playtest PASS |
