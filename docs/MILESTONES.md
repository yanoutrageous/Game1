...
- G19-R4B passed self-check and Godot headless project-load/parser smoke before fast-forward merge to main. G20 docs-only governance branch is in progress; G20 is not merged to main, G21 has not started, R3d1 added branch / commit / validation matrices, R3d2 has not executed, and R3a/R3b/R3c/R3d1 do not claim Godot smoke, gameplay runtime PASS, or manual playtest PASS.
