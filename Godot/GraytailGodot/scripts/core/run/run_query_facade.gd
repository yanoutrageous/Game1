...
func build_result_snapshot(context: RunContext) -> Dictionary:
	...
	return {
		...
		"run_start_config": context.run_start_config.duplicate(true),
		"profile_fields": context.profile_fields.duplicate(true),
		"profile_level": context.profile_level,
		"profile_exp": context.profile_exp,
		"permit_level": context.permit_level,
		"protocol_difficulty": context.protocol_difficulty,
		"talent_interface": context.talent_interface.duplicate(true),
		"active_talent_effects": context.active_talent_effects.duplicate(true),
