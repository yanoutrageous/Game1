...
func _build_backdrop() -> void:
	...
	_add_texture_rect_from_ref(self, "Art21DeployLeftCharacterFrame", Art10UISkinKitScript.rect(&"deploy", "left_column"), Art21UIPlacementContractScript.slot_ref(&"deploy_prep", &"left_character_frame", &"ui.art19.panel.terminal_main"), 0.70)
	_add_texture_rect_from_ref(self, "Art21DeployRouteWall", Rect2(340, 160, 590, 380), Art21UIPlacementContractScript.slot_ref(&"deploy_prep", &"center_route_wall", &"ui.art19.panel.deploy_main"), 0.72)
	_add_texture_rect_from_ref(self, "Art21DeploySummaryPanel", Rect2(952, 88, 286, 396), Art21UIPlacementContractScript.slot_ref(&"deploy_prep", &"right_summary_panel", &"ui.art19.panel.deploy_summary"), 0.76)
