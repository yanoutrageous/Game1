...
const SELECTION_PANE := Rect2(282, 104, 310, 554)
const FILTER_SCROLL := Rect2(286, 104, 302, 38)
const FILTER_SCROLL_WITH_NAV := Rect2(307, 104, 260, 38)
const FILTER_PREVIOUS := Rect2(282, 106, 22, 32)
const FILTER_NEXT := Rect2(570, 106, 22, 32)
const CARD_SCROLL := Rect2(286, 150, 302, 500)
const WAREHOUSE_CARD_SCROLL := Rect2(286, 202, 302, 448)
const WAREHOUSE_BATCH_ENTRY := Rect2(286, 150, 302, 44)
const WAREHOUSE_BATCH_SELECT_ALL := Rect2(286, 150, 147, 44)
const WAREHOUSE_BATCH_CLEAR := Rect2(441, 150, 147, 44)
const RESULT_HINT := Rect2(292, 606, 290, 34)
const DETAIL_PANE := Rect2(604, 104, 310, 554)
const DETAIL_HEADING := Rect2(612, 108, 158, 36)
const DETAIL_GOLD_PANEL := Rect2(778, 108, 128, 36)
const DETAIL_GOLD_ICON := Rect2(784, 114, 24, 24)
const DETAIL_GOLD_VALUE := Rect2(812, 108, 86, 36)
const DETAIL_HEADER := Rect2(612, 150, 294, 116)
const DETAIL_ART_FRAME := Rect2(624, 158, 78, 96)
const DETAIL_ART := Rect2(630, 164, 66, 84)
const DETAIL_TITLE := Rect2(710, 158, 184, 44)
const DETAIL_BADGE := Rect2(710, 204, 184, 50)
const DETAIL_BODY_PANEL := Rect2(612, 274, 294, 252)
const DETAIL_DESCRIPTION := Rect2(624, 286, 270, 66)
const DETAIL_FACT_RECTS := [
	Rect2(624, 356, 270, 34),
	Rect2(624, 394, 270, 34),
	Rect2(624, 432, 270, 34),
	Rect2(624, 470, 270, 50),
]
const DETAIL_FEEDBACK := Rect2(612, 530, 294, 28)
const DETAIL_PRIMARY_ACTION := Rect2(612, 566, 184, 40)
const DETAIL_SECONDARY_ACTION := Rect2(804, 566, 102, 40)
...
const SUMMARY_BODY := Rect2(998, 146, 224, 316)
