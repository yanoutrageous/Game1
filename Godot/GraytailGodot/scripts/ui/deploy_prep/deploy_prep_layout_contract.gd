...
const WAREHOUSE_CARD_SCROLL := Rect2(286, 194, 302, 456)
const WAREHOUSE_BATCH_ENTRY := Rect2(286, 150, 302, 36)
const WAREHOUSE_BATCH_SELECT_ALL := Rect2(286, 150, 147, 36)
const WAREHOUSE_BATCH_CLEAR := Rect2(441, 150, 147, 36)
