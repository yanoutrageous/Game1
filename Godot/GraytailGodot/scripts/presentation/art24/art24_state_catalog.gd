...
const STATES := [
	...
	{"primary_id": &"room", "secondary_id": &"room.chest.open", "room_type": &"chest", "visual_state": &"open", "active_modal": &"none", "protocol_level": 4, "reduce_motion": false},
	{"primary_id": &"room", "secondary_id": &"room.chest.empty", "room_type": &"chest", "visual_state": &"empty", "active_modal": &"none", "protocol_level": 4, "reduce_motion": false},
	...
	{"primary_id": &"loot", "secondary_id": &"loot.spawn", "room_type": &"normal", "visual_state": &"loot_spawned", "active_modal": &"none", "protocol_level": 4, "reduce_motion": false},
	{"primary_id": &"loot", "secondary_id": &"loot.hover", "room_type": &"normal", "visual_state": &"loot_hover", "active_modal": &"none", "protocol_level": 4, "reduce_motion": false},
	{"primary_id": &"loot", "secondary_id": &"loot.panel", "room_type": &"normal", "visual_state": &"loot_spawned", "active_modal": &"ground_loot", "protocol_level": 4, "reduce_motion": false},
	{"primary_id": &"loot", "secondary_id": &"loot.selected", "room_type": &"normal", "visual_state": &"loot_spawned", "active_modal": &"ground_loot_selected", "protocol_level": 4, "reduce_motion": false},
	...
	{"primary_id": &"loot", "secondary_id": &"loot.capacity_blocked", "room_type": &"normal", "visual_state": &"loot_spawned", "active_modal": &"ground_loot_blocked", "protocol_level": 3, "reduce_motion": false},
	{"primary_id": &"loot", "secondary_id": &"loot.replace_preview", "room_type": &"normal", "visual_state": &"loot_spawned", "active_modal": &"ground_loot_replace", "protocol_level": 3, "reduce_motion": false},
